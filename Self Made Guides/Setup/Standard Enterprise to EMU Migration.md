...
- [📋 Overview](#-overview)
- [1️⃣ Pre-Migration Inventory](#1-pre-migration-inventory)
- [2️⃣ Create the New EMU Enterprise](#2-create-the-new-emu-enterprise)
- [3️⃣ Configure Identity Provider](#3-configure-identity-provider)
- [4️⃣ Configure SCIM Provisioning](#4-configure-scim-provisioning)
- [5️⃣ Migrate Repositories](#5-migrate-repositories)
- [6️⃣ Recreate Organization Structure](#6-recreate-organization-structure)
- [7️⃣ Update Integrations](#7-update-integrations)
- [8️⃣ Cutover](#8-cutover)
- [⚠️ Critical EMU Restrictions to Communicate](#-critical-emu-restrictions-to-communicate)
